...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { boolean: @option.boolean, label: @option.label, question_id: @option.question_id, selected: @option.selected } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { boolean: @option.boolean, label: @option.label, question_id: @option.question_id, selected: @option.selected } }
